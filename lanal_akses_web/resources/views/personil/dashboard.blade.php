...
@section('title-page', 'Personil | '. $personil->nama_lengkap)
        ...
        <div class="row">
            <div class="col-md-5 mt-4">
                ...
                <img src="{{  URL::asset('images/admin/default-profile.jpg') }}" alt="default-profile" border="0" height="auto" class="rounded-circle image-profile">
                    <h2 class="mt-3 bluedark text-left jabatan">{{ $personil->nama_lengkap}}</h2>
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="text-left nama">{{ $personil->jabatan }}</h4>
                        <a href="{{ route('personil.edit', ['nrp'=> '26226-P']) }}" class="btn btn-sm btn-outline-secondary">Edit Profil</a>
                    </div>
