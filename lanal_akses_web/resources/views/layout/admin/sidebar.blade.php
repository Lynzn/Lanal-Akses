<div id="sidebar-collapse" class="sidebar fixed-top top-0 bottom-0 bg-greenmain  p-4 " style="height: 100%">
    ...
    <ul id="sidebar-menu" class="my-5 p-0">
        ...
        <a class="p-3 sidebar-item text-uppercase text-white rounded {{ (request()->is('admin/pegawai')) ? 'active-sidebar-item' : '' }}" href="{{  url('/admin/pegawai') }}">
        ...
        <a class="p-3 sidebar-item text-uppercase text-white rounded {{ (request()->is('admin/personil')) ? 'active-sidebar-item' : '' }}" href="{{  url('/admin/personil') }}">
